...
<head>
    ...
    <!-- Favicon -->
    <link href="{{url('frontend/assets/img/favicon.png')}}" rel="shortcut icon" type="image/png">

    <!--fontawesome  -->
    <script src="https://kit.fontawesome.com/d739f16baa.js" crossorigin="anonymous"></script>
...
<body>
                    ...
                    <nav class="navbar navbar-default">
                        <div class="navbar-header">
                            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
                                <span class="sr-only">Toggle navigation <i class="fa-brands fa-facebook"></i></span>
                                <span class="icon-bar"></span>
                                <span class="icon-bar"></span>
                                <span class="icon-bar"></span>
                            </button>
                            <a class="navbar-brand dis-none" href="index-2.html"><img src="{{url('frontend/assets/img/logo-black.png')}}" alt="">
                                </a>
                            <a class="navbar-brand dis-block" href="index-2.html"><img src="{{url('frontend/assets/img/logo-black.png')}}" alt="">
                                </a>
                        </div>
    ...
    <div id="bootstrap-touch-slider" class="carousel bs-slider fade  control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="5000" >
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item active">
                <!-- Slide Background -->
                <img src="{{url('frontend/assets/img/bg/3.jpg')}}" alt="Slider Images"  class="slide-image"/>
            ...
            <div class="item">            
                <!-- Slide Background -->
                <img src="{{url('frontend/assets/img/bg/2.jpg')}}" alt="Slider Images" class="slide-image"/>
                <div class="bs-slider-overlay"></div>
                <!-- Slide Text Layer -->
            ...
            <div class="item">            
                <!-- Slide Background -->
                <img src="{{url('frontend/assets/img/bg/1.jpg')}}" alt="Slider Images"  class="slide-image"/>
                <div class="bs-slider-overlay"></div>
                <!-- Slide Text Layer -->
                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="row margin-top-20">
                            <div class="col-md-6">
                                <img class="margin-top-10" src="{{url('frontend/assets/img/services/s1.jpg')}}" alt="">
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="col-md-5">
                        <div>
                           <img alt="" src="{{url('frontend/assets/img/services/w1.jpg')}}"> 
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class=" animatedParent animateOnce">
        <div class="container padding-bottom-none">
            <div class="section-content">
                <div class="row">
                    <div class="col-md-6">
                        <img class="animated fadeInLeftShort slow delay-500 booking-cantact-img" src="{{url('frontend/assets/img/bg/c1.png')}}" alt="">
                    </div>
   ...
   <!-- divider start -->
    <section class="service-area over-layer-default"
     style="background-image:url('{{ url('frontent/assets/img/bg/5.jpg')}}');">
                ...
                <div class="row clearfix">
                    ...
                    <div class="gallery col-3 gutter">
                        <div class="gallery-item gp-two">
                            <div class="thumb">
                                <img src="{{url('frontend/assets/img/portfolio/1.jpg')}}" alt="">
                                <div class="gallery-hover">
                                    <div class="gallery-info">
                                        <div class="gallery-btn">
                                            <a href="{{url('frontend/assets/img/portfolio/1.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view"> <i class="pe-7s-graph2"></i>  </a>
                                        </div>
                                        <h4><a href="{{url('frontend/assets/img/portfolio/1.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view">Your title here</a></h4>
                        ...
                        <div class="gallery-item gp-three">
                            <div class="thumb">
                                <img src="{{url('frontend/assets/img/portfolio/2.jpg')}}" alt="">
                                <div class="gallery-hover">
                                    <div class="gallery-info">
                                        <div class="gallery-btn">
                                            <a href="{{url('frontend/assets/img/portfolio/2.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view"> <i class="pe-7s-graph2"></i>  </a>
                                        </div>
                                        <h4><a href="{{url('frontend/assets/img/portfolio/2.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view">Your title here</a></h4>
                                        <p><a href="#">Sub Title here</a></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="gallery-item gp-four">
                            <div class="thumb">
                                <img src="{{url('frontend/assets/img/portfolio/3.jpg')}}" alt="">
                                <div class="gallery-hover">
                                    <div class="gallery-info">
                                        <div class="gallery-btn">
                                            <a href="{{url('frontend/assets/img/portfolio/3.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view"> <i class="pe-7s-graph2"></i>  </a>
                                        </div>
                                        <h4><a href="{{url('frontend/assets/img/portfolio/3.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view">Your title here</a></h4>
                                        <p><a href="#">Sub Title here</a></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="gallery-item gp-five">
                            <div class="thumb">
                                <img src="{{url('frontend/assets/img/portfolio/4.jpg')}}" alt="">
                                <div class="gallery-hover">
                                    <div class="gallery-info">
                                        <div class="gallery-btn">
                                            <a href="{{url('frontend/assets/img/portfolio/4.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view"> <i class="pe-7s-graph2"></i>  </a>
                                        </div>
                                        <h4><a href="{{url('frontend/assets/img/portfolio/4.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view">Your title here</a></h4>
                                        <p><a href="#">Sub Title here</a></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="gallery-item gp-two">
                            <div class="thumb">
                                <img src="{{url('frontend/assets/img/portfolio/5.jpg')}}" alt="">
                                <div class="gallery-hover">
                                    <div class="gallery-info">
                                        <div class="gallery-btn">
                                            <a href="{{url('frontend/assets/img/portfolio/5.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view"> <i class="pe-7s-graph2"></i>  </a>
                                        </div>
                                        <h4><a href="{{url('frontend/assets/img/portfolio/5.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view">Your title here</a></h4>
                                        <p><a href="#">Sub Title here</a></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="gallery-item gp-three">
                            <div class="thumb">
                                <img src="{{url('frontend/assets/img/portfolio/6.jpg')}}" alt="">
                                <div class="gallery-hover">
                                    <div class="gallery-info">
                                        <div class="gallery-btn">
                                            <a href="{{url('frontend/assets/img/portfolio/6.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view"> <i class="pe-7s-graph2"></i>  </a>
                                        </div>
                                        <h4><a href="{{url('frontend/assets/img/portfolio/6.jpg')}}" data-fancybox-group="gallery" class="lightbox-image" title="lightbox view">Your title here</a></h4>
                                        <p><a href="#">Sub Title here</a></p>
                                    </div>
                                </div>
                            </div>
   ...
   <!-- divider start -->
    <section class="divider divider-video over-layer-white" style="background-image:url('{{asset('frontend/assets/img/bg/6.jpg')}}');">
        <div class="container">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="practice-item-1">
                            <div class="practice-img">
                                <a href="#">
                                    <img src="{{url('frontend/assets/img/services/4.jpg')}}" alt="">
                                    <span class="flaticon-heart-1"></span>
                                </a>
                            </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="practice-item-1">
                            <div class="practice-img">
                                <a href="#">
                                    <img src="{{url('frontend/assets/img/services/5.jpg')}}" alt="">
                                    <span class="flaticon-heart-1"></span>
                                </a>
                            </div>
                            <div class="practice-content">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="practice-item-1">
                            <div class="practice-img">
                                <a href="#">
                                    <img src="{{url('frontend/assets/img/services/6.jpg')}}" alt="">
                                    <span class="flaticon-heart-1"></span>
                                </a>
                            </div>
                            <div class="practice-content">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="practice-item-1">
                            <div class="practice-img">
                                <a href="#">
                                    <img src="{{url('frontend/assets/img/services/1.jpg')}}" alt="">
                                    <span class="flaticon-heart-1"></span>
                                </a>
                            </div>
                            <div class="practice-content">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="practice-item-1">
                            <div class="practice-img">
                                <a href="#">
                                    <img src="{{url('frontend/assets/img/services/8.jpg')}}" alt="">
                                    <span class="flaticon-heart-1"></span>
                                </a>
                            </div>
                            <div class="practice-content">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="practice-item-1">
                            <div class="practice-img">
                                <a href="#">
                                    <img src="{{url('frontend/assets/img/services/3.jpg')}}" alt="">
                                    <span class="flaticon-heart-1"></span>
                                </a>
                            </div>
                            <div class="practice-content">
                    ...
                    <div class="team-carousel">
                        <div class="item">
                            <div class="team-item-2">
                                <img src="{{url('frontend/assets/img/team/1.png')}}" alt="">
                        ...
                        <div class="item">
                            <div class="team-item-2">
                                <img src="{{url('frontend/assets/img/team/2.png')}}" alt="">
                                <div class="team-contact">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                        <li><a href="#"><i class="fa fa-linkedin"></i></a></li>
                        ...
                        <div class="item">
                            <div class="team-item-2">
                                <img src="{{url('frontend/assets/img/team/3.png')}}" alt="">
                                <div class="team-contact">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                        <li><a href="#"><i class="fa fa-linkedin"></i></a></li>
                        ...
                        <div class="item">
                            <div class="team-item-2">
                                <img src="{{url('frontend/assets/img/team/4.png')}}" alt="">
                                <div class="team-contact">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                        <li><a href="#"><i class="fa fa-linkedin"></i></a></li>
                        ...
                        <div class="item">
                            <div class="team-item-2">
                                <img src="{{url('frontend/assets/img/team/5.png')}}" alt="">
                                <div class="team-contact">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                        <li><a href="#"><i class="fa fa-linkedin"></i></a></li>
    ...
    <!-- Counter start -->
    <section class="funfact-field over-layer-default" style="background-image: url('{{asset('frontend/assets/img/bg/6.jpg')}}')">
                        ...
                        <div class="testimonial-carousel-one">
                                ...
                                <div class="testimonial-item text-center">
                                    <div class="testimonial-author">
                                        <div class="author-img">
                                            <img class="img-responsive" src="{{url('frontend/assets/img/testimonial/1.png')}}" alt="" />
                                        </div>
                                        <h4>John Daniel</h4>
                                        <h6>business man</h6>
                                        <ul>
                            ...
                            <div class="item">
                                <div class="testimonial-item text-center">
                                    <div class="testimonial-author">
                                        <div class="author-img">
                                            <img class="img-responsive" src="{{url('frontend/assets/img/testimonial/2.png')}}" alt="" />
                                        </div>
                                        <h4>John Daniel</h4>
                                        <h6>business man</h6>
                                        <ul>
                            ...
                            <div class="item">
                                <div class="testimonial-item text-center">
                                    <div class="testimonial-author">
                                        <div class="author-img">
                                            <img class="img-responsive" src="{{url('frontend/assets/img/testimonial/3.png')}}" alt="" />
                                        </div>
                                        <h4>John Daniel</h4>
                                        <h6>business man</h6>
                                        <ul>
                    ...
                    <div class="blog-feature">
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="blog-item style-1">
                                ...
                                <div class="blog-img"><a href="#"><img src="{{url('frontend/assets/img/blog/1.jpg')}}" alt=""></a>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="blog-item style-1">
                                ...
                                <div class="blog-img"><a href="#"><img src="{{url('frontend/assets/img/blog/2.jp')}}g" alt=""></a>
                                    <div class="blog-event-date">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 center-block">
                            <div class="blog-item style-1">
                                ...
                                <div class="blog-img"><a href="#"><img src="{{url('frontend/assets/img/blog/3.jpg')}}" alt=""></a>
                                    <div class="blog-event-date">
   ...
   <!-- blog end -->
                ...
                <div class="row margin-top-30">
                    <div class="col-md-3">
                      <div class="footer-item footer-widget-one">
                          <img alt="" src="{{url('frontend/assets/img/logo.png')}}" class="footer-logo">
                      ...
                      <div class="footer-item">
                        <div class="footer-item clearfix">
                          ...
                          <div class="flicker-feed gutter">
                            <a href="{{url('frontend/assets/img/flicker/1.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{url('frontend/assets/img/flicker/1.jpg')}}" alt=""></a>
                            <a href="{{url('frontend/assets/img/flicker/2.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{url('frontend/assets/img/flicker/2.jpg')}}" alt=""></a>
                            <a href="{{url('frontend/assets/img/flicker/3.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{url('frontend/assets/img/flicker/3.jpg')}}" alt=""></a>
                            <a href="{{url('frontend/assets/img/flicker/4.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{url('frontend/assets/img/flicker/4.jpg')}}" alt=""></a>
                            <a href="{{url('frontend/assets/img/flicker/5.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{url('frontend/assets/img/flicker/5.jpg')}}" alt=""></a>
                            <a href="{{url('frontend/assets/img/flicker/6.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{url('frontend/assets/img/flicker/6.jpg')}}" alt=""></a>
                            <a href="{{url('frontend/assets/img/flicker/7.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{url('frontend/assets/img/flicker/7.jpg')}}" alt=""></a>
                            <a href="{{url('frontend/assets/img/flicker/8.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{url('frontend/assets/img/flicker/8.jpg')}}" alt=""></a>
                            <a href="{{url('frontend/assets/img/flicker/9.jpg')}}" class="lightbox-image" title="Image Caption Here"><img src="{{url('frontend/assets/img/flicker/9.jpg')}}" alt=""></a>
                          </div>
                        </div>
                      </div>
                    </div>
    ...
    <script type="text/javascript" src="{{url('frontend/assets/js/bootstrap-datepicker.min.js')}}"></script>
    <script type="text/javascript" src="{{url('frontend/assets/js/css3-animate-it.js')}}"></script>
    <script type="text/javascript" src="{{url('frontend/assets/js/bootstrap-dropdownhover.min.js')}}"></script>
    <script type="text/javascript" src="{{url('frontend/assets/js/owl.carousel.min.js')}}"></script>
    <script type="text/javascript" src="{{url('frontend/assets/js/gallery.js')}}"></script>
    <script type="text/javascript" src="{{url('frontend/assets/js/player.min.js')}}"></script>
    <script type="text/javascript" src="{{url('frontend/assets/js/retina.js')}}"></script>
    <script type="text/javascript" src="{{url('frontend/assets/js/comming-soon.js')}}"></script>
