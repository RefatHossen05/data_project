...
<h1 class="text-center bg-success text-white p-2">Add Report Infromation</h1>
<div class="container mx-auto">
    ...
    @csrf
        ...
        <div class="form-group my-2">
         ...
         <input type="text" class="form-control" name="test_name" placeholder="Test Name" id="test_name">
        </div>
